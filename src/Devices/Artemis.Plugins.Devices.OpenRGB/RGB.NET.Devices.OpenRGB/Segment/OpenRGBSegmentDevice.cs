...
public sealed class OpenRGBSegmentDevice : AbstractOpenRGBDevice<OpenRGBDeviceInfo>
{
    ...
    public OpenRGBSegmentDevice(OpenRGBDeviceInfo info, int initialLed, int zoneIndex, int segmentIndex, Segment segment, IUpdateQueue updateQueue)
        : base(info, updateQueue, $"zone:{zoneIndex}:segment:{segmentIndex}")
    {
